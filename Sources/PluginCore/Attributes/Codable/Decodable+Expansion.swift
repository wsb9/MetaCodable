...
extension DecodableMacro: MemberMacro, ExtensionMacro {
...
//            .init(stringLiteral: TypeCodingLocation.Method.encode.protocol),
    ...
    package static func expansion(
        ...
        let exts = exp.decodableExpansion(for: type, to: protocols, in: context)
    ...
    package static func expansion(
        ...
        var exts = exp.decodableExpansion(for: type, to: protocols, in: context)
